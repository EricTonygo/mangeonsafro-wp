...
<section class="hero">
    <div class="container">
        ...
        <div class="hero-content text-center">
            <h3 class="hero-heading"><?php _e("Products of", "mangeonsafrodomain"); ?> <?php the_title(); ?></h3>
        </div>
    </div>
</section>
<section>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 mb-5">
                <div class="customer-sidebar card border-0"> 
                    ...
                    <nav class="list-group customer-nav"><a href="<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('account', 'mangeonsafrodomain') . "/" . __('seller-zone', 'mangeonsafrodomain') . "/" . __('products', 'mangeonsafrodomain'))->ID)) ?>" class="active list-group-item d-flex justify-content-between align-items-center"><span>
