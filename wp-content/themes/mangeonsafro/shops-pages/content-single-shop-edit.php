...
<section class="hero">
    <div class="container">
        ...
        <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo wp_make_link_relative(get_permalink()) ?>"><?php the_title(); ?></a></li>
        </ol>
        <!-- Hero Content-->
        ...
        <div class="row">
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="block mb-5">
                    <div class="block-header"><strong class="text-uppercase"><?php _e("Edit shop", "mangeonsafrodomain"); ?></strong></div>
                    <div class="block-body">
                        <?php include(locate_template("statics-pages/content-success-or-faillure-message.php")); ?>
                        <form method="POST" action="<?php echo wp_make_link_relative(get_permalink()) ?>" autocomplete="off">
                            <!-- /.row-->
                            <div class="row">
                                <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="shop-city" type="text" name="shop-city" class="form-control" placeholder="<?php _e("Shop city", "mangeonsafrodomain"); ?>" value="<?php echo $shop_city; ?>" required="true">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="shop-country" class="form-label"><?php _e("Country", "mangeonsafrodomain"); ?></label>                                        
                                        <select id="shop-country" name="shop-country" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="shop-description" class="form-label"><?php _e("Description", "mangeonsafrodomain"); ?></label>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-outline-dark"><i class="far fa-save mr-2"></i><?php _e("Save updates", "mangeonsafrodomain"); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 mb-5">
                <div class="customer-sidebar card border-0"> 
                    ...
                    <nav class="list-group customer-nav"><a href="<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('account', 'mangeonsafrodomain') . "/" . __('seller-zone', 'mangeonsafrodomain') . "/" . __('shops', 'mangeonsafrodomain'))->ID)) ?>" class="active list-group-item d-flex justify-content-between align-items-center"><span>
                        ...
                        <?php if (is_user_logged_in() && $single_shop_id): ?>
                            <a href="<?php echo esc_url(add_query_arg(array('shop-id' => $single_shop_id), wp_make_link_relative(get_permalink(get_page_by_path(__('account', 'mangeonsafrodomain') . "/" . __('seller-zone', 'mangeonsafrodomain') . "/" . __('products', 'mangeonsafrodomain'))->ID)))) ?>" class="list-group-item d-flex justify-content-between align-items-center">
                        <?php else: ?>
