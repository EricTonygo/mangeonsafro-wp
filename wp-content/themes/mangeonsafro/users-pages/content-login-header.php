<div id="second_menu" class="ui stackable menu">
    <div class="ui container">
        ...
        <div class="right menu">
            <div class="item"><span style="padding-right: 0.5em;"><?php _e("Do not already have an account", "booksharedomain"); ?>?</span> <a href="<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('register', 'booksharedomain')))) ?>"><?php _e("Sign up", "booksharedomain"); ?></a></div>                    
        </div>
