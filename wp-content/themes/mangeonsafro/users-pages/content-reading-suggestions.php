<div id="nav_menu" class="ui tiny menu">
    <div class="left menu">
        <ul class="breadcrumb">
            ...
            <li><i class="small right chevron icon divider"></i></li>
            <li class=""><span><?php _e("Reading suggestions", "booksharedomain"); ?></span></li>
        </ul>
    </div>
</div>
    ...
    <div class="twelve wide stretched column">
        <div class="ui fluid card account_left_main_content">
            <div class="content">
                ...
                <?php
                if ($publications && $publications->have_posts()) :
                    ?>
                    <div class="fluid card" style="margin-bottom: 1em;">
                        <div class="content">
                            <div class="ui warning message">
                                <i class="close icon"></i>
                                <?php _e("We use your hobbies to give you a rigth reading suggestions", "booksharedomain"); ?>
                            </div>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    <div class="ui warning message">
                        <i class="close icon"></i>
                        <?php _e("We don't have a reading suggestions for you at the moment. If you haven't specified yet your hobbies in your profile, please do it first", "booksharedomain"); ?>.                        
                    </div>
                <?php
                endif;
                wp_reset_postdata();
